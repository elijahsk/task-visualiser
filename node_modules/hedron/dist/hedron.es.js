import React, { Children, Component, PropTypes, createElement } from 'react';
...
/* globals ReactClass */
var breakpointsShape = index$1$1.shape({
  sm: index$1$1.number,
  md: index$1$1.number,
  lg: index$1$1.number
});
...
var BreakpointProvider = function (_Component) {
  inherits$1(BreakpointProvider, _Component);

  function BreakpointProvider() {
    classCallCheck$1(this, BreakpointProvider);
    return possibleConstructorReturn$1(this, (BreakpointProvider.__proto__ || Object.getPrototypeOf(BreakpointProvider)).apply(this, arguments));
  }

  createClass$1(BreakpointProvider, [{
    key: 'getChildContext',
    value: function getChildContext() {
      ...
      return {
        breakpoints: _extends$1({}, defaultBreakpoints, contextBreakpoints, propsBreakpoints)
      };
    }
  }, {
    key: 'render',
...
// eslint-disable-next-line react/no-multi-comp
  ...
  return _temp = _class = function (_Component2) {
    inherits$1(Breakpoints, _Component2);

    function Breakpoints() {
      classCallCheck$1(this, Breakpoints);
      return possibleConstructorReturn$1(this, (Breakpoints.__proto__ || Object.getPrototypeOf(Breakpoints)).apply(this, arguments));
    }

    createClass$1(Breakpoints, [{
      key: 'render',
      value: function render() {
        var breakpoints = this.context.breakpoints;


        return React.createElement(WrappedComponent, _extends$1({}, this.props, { breakpoints: breakpoints }));
...
HiddenContainer.propTypes = {
  children: require('react').PropTypes.node,
  debug: require('react').PropTypes.bool,
  xs: require('react').PropTypes.bool,
  sm: require('react').PropTypes.bool,
  md: require('react').PropTypes.bool,
  lg: require('react').PropTypes.bool,
  breakpoints: require('react').PropTypes.object
};
...
RowContainer.propTypes = {
  ...
  debug: require('react').PropTypes.bool,
  tagName: require('react').PropTypes.string,
  theme: require('react').PropTypes.object,
  divisions: require('react').PropTypes.number,
  alignContent: require('react').PropTypes.string,
  alignItems: require('react').PropTypes.string,
  alignSelf: require('react').PropTypes.string,
  justifyContent: require('react').PropTypes.string,
  order: require('react').PropTypes.string
};
...
ColumnContainer.propTypes = {
  ...
  xsShift: require('react').PropTypes.number,
  smShift: require('react').PropTypes.number,
  mdShift: require('react').PropTypes.number,
  lgShift: require('react').PropTypes.number,
  breakpoints: require('react').PropTypes.object
};
...
PageContainer.propTypes = {
  ...
  debug: require('react').PropTypes.bool,
  fluid: require('react').PropTypes.bool,
  width: require('react').PropTypes.string
};
...
export { Column$1 as Column, Page, Row, Hidden$1 as Hidden, BreakpointProvider, withBreakpoints, index$2$1 as utils };
